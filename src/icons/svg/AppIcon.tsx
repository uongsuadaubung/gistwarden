...
export const AppIcon: Component<IconProps> = (props) => {
  return (
    <svg viewBox="0 0 512 512" {...props}>
      ...
      {/* Dây khung hình khiên 3D màu xanh dương (Royal Blue) */}
      <g
        stroke="#175ddc"
        stroke-width="18"
      ...
      >
        ...
        <path d="M 118,142 L 162,175" /> {/* Góc trên bên trái */}
        <path d="M 256,432 L 256,388" /> {/* Đáy khiên */}
      </g>

      {/* Lỗ khóa màu trắng ở chính giữa tâm khiên */}
      <g fill="#ffffff">
        {/* Đầu lỗ khóa hình tròn */}
        <circle cx="256" cy="235" r="32" />
        {/* Chân lỗ khóa hình thang */}
        <path d="M 242,255 L 270,255 L 278,320 L 234,320 Z" />
      </g>
    </svg>
  );
};
