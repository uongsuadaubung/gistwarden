...
import { type Component, Show, Switch, Match, onMount } from "solid-js";
import { store, storeActions, View } from "@/shared/store.ts";
import { SyncIcon, LockIcon, GeneratorIcon, SettingsIcon } from "@/icons/svg/index.ts";
    ...
    <Show when={store.isLoaded} fallback={
      <div style="display: flex; align-items: center; justify-content: center; height: 100%; width: 100%; color: var(--text-muted); background-color: var(--bg-dark);">
        <div style="text-align: center;">
          <SyncIcon class="spinning" style="width: 28px; height: 28px; fill: var(--primary); margin: 0 auto 12px;" />
      ...
      <Switch>
        ...
        <Match when={true}>
          <div class="app-container">
            ...
            <Show when={store.view !== View.ItemDetail && store.view !== View.ItemEdit}>
              <nav class="app-nav">
                <div
                  class={`nav-item ${store.view === View.Vault ? "active" : ""}`}
                ...
                <div
                  class={`nav-item ${store.view === View.Generator ? "active" : ""}`}
                ...
                <div
                  class={`nav-item ${store.view === View.Settings ? "active" : ""}`}
