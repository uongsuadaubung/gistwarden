...
export const MSG_USER_ACTIVITY = "USER_ACTIVITY";
...
export const MSG_VAULT_ITEMS_UPDATED = "VAULT_ITEMS_UPDATED";
...
export const MSG_CREDENTIALS_SUBMITTED = "CREDENTIALS_SUBMITTED";
export const MSG_SHOW_NOTIFICATION_BAR = "SHOW_NOTIFICATION_BAR";
export const MSG_SAVE_CREDENTIAL_ACTION = "SAVE_CREDENTIAL_ACTION";
export const MSG_CHECK_PENDING_NOTIFICATION = "CHECK_PENDING_NOTIFICATION";
export const MSG_CHECK_AUTOFILL_SUGGESTION = "CHECK_AUTOFILL_SUGGESTION";
export const STORAGE_KEY_UNAPPROVED_PENDING_LOGINS =
  "unapproved_pending_logins";
...
// Session Keys cleared on Lock / Timeout / Logout
export const SESSION_KEYS_ON_LOCK = [
