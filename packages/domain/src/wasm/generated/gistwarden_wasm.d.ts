...
export function batch_parse_hibp_response(
  response_text: string,
  suffixes_json: string,
): string;

export function cbor_byte_string(bytes: Uint8Array): Uint8Array;

export function cbor_encode_length(
  major_type: number,
  length: number,
): Uint8Array;
...
export function decode_qr_code(
  width: number,
  height: number,
...
export function derive_key_argon2id(
  password: string,
  salt: Uint8Array,
...
export function encode_cose_ec2_public_key(
  x: Uint8Array,
  y: Uint8Array,
): Uint8Array;

export function estimate_password_strength(
  password: string,
  user_inputs_json: string,
): string;

export function export_to_bitwarden_csv(
  items_json: string,
  folders_json: string,
): string;
...
export function filter_matching_domain_items(
  items_json: string,
  domain_or_url: string,
  override_mode?: number | null,
): string;

export function filter_matching_domain_items_js(
  items_val: any,
  domain_or_url: string,
  override_mode?: number | null,
): any;

export function filter_vault_items_by_query(
  items_json: string,
  search_query: string,
  filter_type: string,
): string;

export function filter_vault_items_by_query_js(
  items_val: any,
  search_query: string,
  filter_type: string,
): any;

export function generate_assertion_signature_base(
  auth_data: Uint8Array,
  client_data_hash: Uint8Array,
): Uint8Array;

export function generate_auth_data(
  rp_id: string,
  counter: number,
  user_present: boolean,
  user_verified: boolean,
  credential_id?: Uint8Array | null,
  key_x?: Uint8Array | null,
  key_y?: Uint8Array | null,
): Uint8Array;

export function generate_passphrase(
  num_words: number,
...
export function hash_password_argon2id(
  password: string,
  salt: Uint8Array,
  iterations?: number | null,
  memory_kib?: number | null,
...
export function merge_folders(
  local_folders_json: string,
  remote_folders_json: string,
): string;

export function merge_folders_js(local_val: any, remote_val: any): any;

export function merge_vault_items(
  local_items_json: string,
  remote_items_json: string,
  last_sync_timestamp: bigint,
): string;

export function merge_vault_items_js(
  local_val: any,
  remote_val: any,
  last_sync_timestamp: bigint,
): any;

export function merge_vault_payload(
  local_json: string,
  remote_json: string,
  last_sync_timestamp: bigint,
): string;

export function merge_vault_payload_js(
  local_val: any,
  remote_val: any,
  last_sync_timestamp: bigint,
): any;
...
export function parse_bitwarden_csv_import(
  csv_text: string,
  existing_folders_json: string,
): string;
...
export function parse_hibp_response(
  response_text: string,
  suffix: string,
): number;

export function parse_json_import(
  json_text: string,
  existing_items_json: string,
  existing_folders_json: string,
): string;
...
export interface InitOutput {
  ...
  readonly batch_parse_hibp_response: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly encode_cose_ec2_public_key: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly estimate_password_strength: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly export_to_bitwarden_csv: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly filter_matching_domain_items: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly filter_matching_domain_items_js: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly filter_vault_items_by_query: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly filter_vault_items_by_query_js: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly generate_assertion_signature_base: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly hash_password_argon2id: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly merge_vault_items_js: (
    a: number,
    b: number,
    c: number,
    d: bigint,
  ) => void;
  readonly merge_vault_payload: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly merge_vault_payload_js: (
    a: number,
    b: number,
    c: number,
    d: bigint,
  ...
  readonly parse_bitwarden_csv_import: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly parse_hibp_response: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => number;
  readonly parse_json_import: (
    a: number,
    b: number,
    c: number,
    d: number,
