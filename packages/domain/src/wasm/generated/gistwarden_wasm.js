...
export function derive_key_argon2id(
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    wasm.derive_key_argon2id(
      retptr,
      ptr0,
      len0,
      ptr1,
      len1,
      isLikeNone(iterations) ? Number.MAX_SAFE_INTEGER : iterations >>> 0,
      isLikeNone(memory_kib) ? Number.MAX_SAFE_INTEGER : memory_kib >>> 0,
      isLikeNone(hash_length) ? Number.MAX_SAFE_INTEGER : hash_length >>> 0,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
export function filter_matching_domain_items(
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    wasm.filter_matching_domain_items(
      retptr,
      ptr0,
      len0,
      ptr1,
      len1,
      isLikeNone(override_mode) ? 0xFFFFFF : override_mode,
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
export function filter_matching_domain_items_js(
  ...
  try {
    ...
    const len0 = WASM_VECTOR_LEN;
    wasm.filter_matching_domain_items_js(
      retptr,
      addHeapObject(items_val),
      ptr0,
      len0,
      isLikeNone(override_mode) ? 0xFFFFFF : override_mode,
    );
...
export function filter_vault_items_by_query(
  ...
  try {
    ...
    const len2 = WASM_VECTOR_LEN;
    wasm.filter_vault_items_by_query(
      retptr,
      ptr0,
      len0,
      ptr1,
...
export function filter_vault_items_by_query_js(
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    wasm.filter_vault_items_by_query_js(
      retptr,
      addHeapObject(items_val),
      ptr0,
      len0,
...
export function generate_auth_data(
  ...
  try {
    ...
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(credential_id)
      ? 0
      : passArray8ToWasm0(credential_id, wasm.__wbindgen_export);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(key_x)
      ? 0
      : passArray8ToWasm0(key_x, wasm.__wbindgen_export);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(key_y)
      ? 0
      : passArray8ToWasm0(key_y, wasm.__wbindgen_export);
    var len3 = WASM_VECTOR_LEN;
    wasm.generate_auth_data(
      retptr,
      ptr0,
      len0,
      counter,
...
export function generate_passphrase(
  ...
  try {
    ...
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(wordlist)
      ? 0
      : passArrayJsValueToWasm0(wordlist, wasm.__wbindgen_export);
    var len1 = WASM_VECTOR_LEN;
    wasm.generate_passphrase(
      retptr,
      num_words,
      ptr0,
      len0,
...
export function merge_folders_js(local_val, remote_val) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.merge_folders_js(
      retptr,
      addHeapObject(local_val),
      addHeapObject(remote_val),
    );
    var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
    var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
function __wbg_get_imports() {
  const import0 = {
    ...
    __wbg_getRandomValues_ceb34d8ffce7e87f: function () {
      return handleError(function (arg0, arg1) {
