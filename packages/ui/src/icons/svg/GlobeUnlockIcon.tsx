...
export const GlobeUnlockIcon: Component<IconProps> = (props) => {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="M18 6V4c0-1.1-.9-2-2-2s-2 .9-2 2v2h-1v6h6V8h-1zm-1 0h-2V4c0-.55.45-1 1-1s1 .45 1 1v2z" />
    </svg>
  );
};
export default GlobeUnlockIcon;
